...
var names = document.querySelector("td:nth-of-type(5) tei-name")
var theArray = Array.from(names);

//cut the first row (th)
var slicedArray = theArray.slice(1);
//Run the sort() method on the sliced array, to make it alpahabetical
